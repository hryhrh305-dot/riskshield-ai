...
describe("E8.7 artifact and surface safety", () => {
  it("keeps printed page tops clear and renders semantic decision colors", () => {
    ...
    expect(markup).toContain('class="report-header-tools flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between"');
    expect(markup).toContain('class="report-header-summary w-full min-w-0"');
    expect(markup).not.toContain("lg:flex-row lg:items-start lg:justify-between");
