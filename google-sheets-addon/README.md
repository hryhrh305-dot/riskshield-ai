...
6. Use **Scan Selected Emails** or **Scan Entire Column**. A run supports up to 5,000 unique valid emails, processes 50-contact chunks, and resumes through a time-based trigger when required.
