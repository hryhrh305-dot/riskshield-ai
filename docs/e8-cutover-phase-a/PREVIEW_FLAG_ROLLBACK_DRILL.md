...
3. Attempted a new Legacy Test checkout.
   - Failed with provider `404 Product not found` because the Test account had only the six V2 Test Products.
...
- New Legacy Test payment during rollback: Blocked by missing Legacy Test Product mapping.
